...
//On Boarding Group..
defined('ON_BOARDING')|| define('ON_BOARDING', 14);
/* Default gmt offset */
...
defined('DONOTREPLYNAME') || define('DONOTREPLYNAME', 'VHRIS');
...
// define path upto /public
defined('MEDIA_PATH_NEW') || define('MEDIA_PATH_NEW', $domainurl.'/public/media_new/');
...
defined('PAYROLL')|| define('PAYROLL', 201);
defined('ATTENDANCE')|| define('ATTENDANCE', 223);
defined('COMPONENTSGROUP')|| define('COMPONENTSGROUP', 204);
defined('COMPONENTS')|| define('COMPONENTS', 205);
defined('EMPLOYEECOMPONENTS')|| define('EMPLOYEECOMPONENTS', 206);
defined('PAYROLLPERIODS')|| define('PAYROLLPERIODS', 207);
defined('FORMULAFIELDS')|| define('FORMULAFIELDS', 208);
defined('GENERATEPAYROLL')|| define('GENERATEPAYROLL', 209);
defined('DOWNLOADPAYSLIP')|| define('DOWNLOADPAYSLIP', 210);
defined('PAYROLLADVANCES')|| define('PAYROLLADVANCES', 220);
defined('PAYROLLMYADVANCES')|| define('PAYROLLMYADVANCES', 221);
defined('PAYROLLEMPADVANCES')|| define('PAYROLLEMPLOYEEADVANCES', 222);
defined('PAYROLLATTENDANCEREPORT')|| define('PAYROLLATTENDANCEREPORT', 224);
defined('PAYROLLATTENDANCEREQUEST')|| define('PAYROLLATTENDANCEREQUEST', 225);
defined('ONBOARDINGCANDIDATES')|| define('ONBOARDINGCANDIDATES',226);
defined('EMPLOYEEATTENDANCEAPPROVALS')|| define('EMPLOYEEATTENDANCEAPPROVALS',227);
defined('SHIFTMANAGEMENT')|| define('SHIFTMANAGEMENT',228);
defined('SHIFTTYPES')|| define('SHIFTTYPES',229);