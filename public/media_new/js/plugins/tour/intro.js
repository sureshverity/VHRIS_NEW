(function (w, p) {
    ...
    function J(a) {
        ...
        K.call(c, a) && (x.call(c), a.querySelector(".introjs-skipbutton"), a.querySelector(".introjs-nextbutton"),
            c._onKeyDown = function (b) {
                if (27 === b.keyCode && !0 == c._options.exitOnEsc) y.call(c, a), void 0 != c._introExitCallback && c._introExitCallback.call(c);
                else if (37 === b.keyCode) C.call(c);
                else if (39 === b.keyCode) x.call(c);
    ...
    function x() {
        ...
        if (this._introItems.length <= this._currentStep) "function" === typeof this._introCompleteCallback && this._introCompleteCallback.call(this), y.call(this, this._targetElement);
        else {
    ...
    function G(a) {
        ...
        if (null != c) {
            ...
            if ((g = document.querySelectorAll(".introjs-fixParent")) && 0 < g.length)
                for (e = g.length - 1; 0 <= e; e--) g[e].className =
    ...
    B.fn = p.prototype = {
        ...
        onbeforechange: function (a) {
            if ("function" ===
                typeof a) this._introBeforeChangeCallback = a;
        ...
        oncomplete: function (a) {
            if ("function" ===
                typeof a) this._introCompleteCallback = a;
