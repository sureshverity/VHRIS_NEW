	...
	public function init()
	{
       ...
       $this->setAttrib('name','creditcarddetails');
        ...
        //Card Type....(only alphabets)
         ...
         $cardType->setAttrib("class", "form-control");
		 ...
		 $cardType->addValidators(array(
          ...
          //Card Number....
             ...
             $cardNum->setAttrib("class", "form-control");
		...
		//Name on the card .... (only Alphabets)
         ...
         $nameoncard->setAttrib("class", "form-control");
        ...
        $card_expired_date->setAttrib("class", "form-control");
		...
		$card_expired_date->addValidator(new sapp_DateGreaterThanToday());
         ...
         $card_code->setAttrib("class", "form-control");
        ...
        $card_issuedBy->setAttrib("class", "form-control");
