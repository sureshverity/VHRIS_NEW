...
class Default_Form_jobtitles extends Zend_Form
{
	public function init()
	{
        ...
        $jobtitlecode->setAttrib("class", "form-control");
        ...
        $jobtitlename->setAttrib("class", "form-control");
        ...
        $minexperiencerequired->setAttrib("class", "form-control");
        ...
        $jobpaygradecode->setAttrib("class", "form-control");
        ...
        $jobpayfrequency->setAttrib("class", "form-control select");
