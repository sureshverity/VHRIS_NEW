...
class Default_Form_empcommunicationdetails extends Zend_Form
{
    public function init()
    {
        ...
        $personalemail->setAttrib("class", "form-control");
        ...
        $perm_streetaddress->setAttrib("class", "form-control");
        ...
        $perm_country->setAttrib("class", "form-control");
        ...
        $perm_pincode->setAttrib("class", "form-control");
        ...
        $current_state->setAttrib("class", "form-control");
        ...
        $current_city->setAttrib("class", "form-control");
        ...
        $current_pincode->setAttrib("class", "form-control");
        ...
        $emergency_number->setAttrib("class", "form-control");
        ...
        $emergency_name->setAttrib("class", "form-control");
        ...
        $emergency_email->setAttrib("class", "form-control");
