...
class Default_Form_servicedeskconf extends Zend_Form
{
	public function init()
	{
		...
		$businessunit_id->setLabel("Business Unit");
                $businessunit_id->setAttrib("class", "form-control");
		...
		$service_desk_flag->setRequired(true);
                $service_desk_flag->setAttrib("class", "iradio");
		...
		$request_for->setRequired(true);
                $request_for->setAttrib("class", "form-control");
        ...
        //$service_desk_id->setAttrib('class', 'selectoption');
         $service_desk_id->setAttrib("class", "form-control select");
		...
		$request_recievers = new Zend_Form_Element_select('request_recievers');
		$request_recievers->setLabel("Executors");
        $request_recievers->setAttrib("class", "form-control select");
        ...
        $approvingauthority->setAttrib("class", "form-control select");
       ...
       // $approver_1->setAttrib('class', 'selectoption');
        $approver_1->setAttrib("class", "form-control select");
        ...
        $approver_2->setAttrib('class', 'form-control select');
        ...
        $approver_3->setAttrib('class', 'form-control select');
        $approver_3->addMultiOption('','Select Approver 3');
		$approver_3->setRegisterInArrayValidator(false);
		
		$cc_mail_recievers = new Zend_Form_Element_select('cc_mail_recievers');
		$cc_mail_recievers->setLabel("Request Viewers");
        $cc_mail_recievers->setAttrib('class', 'form-control select');
		...
		$attachment->setValue(0);	
                 $attachment->setAttrib("class", "iradio");
