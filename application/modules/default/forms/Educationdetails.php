...
{ 
	public function init()
	{
        ...
        $remarks->addFilter(new Zend_Filter_StringTrim());
        
		$remarks->setAttrib("maxlength",300);
        $remarks->addValidator('NotEmpty', false, array('messages' => 'Please enter remarks.'));
		
		$remarks->addValidators(array(
						 array(
							 'validator'   => 'Regex',
							 'breakChainOnFailure' => true,
							 'options'     => array( 
							 'pattern' =>'/^[a-zA-Z0-9\-\.\s]+$/i',
								 'messages' => array(
										 'regexNotMatch'=>'Please enter remarks.'
								 )
							 )
						 )
					 )); 
	   ...
	   //Form Submit....
		...
		$this->addElements(array($id,$user_id,$educationlevel,$from_date,$to_date,$percentage,$course,$remarks,$institution_name,
							$submit));
