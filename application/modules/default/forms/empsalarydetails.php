...
class Default_Form_empsalarydetails extends Zend_Form
{
	public function init()
	{
        ...
        $currencyid->setAttrib("class", "form-control");
        ...
        $salarytype->setAttrib("class", "form-control");
        ...
        $bankname->setAttrib("class", "form-control");
        ...
        $accountholder_name->setAttrib("class", "form-control");
        ...
        $accountholding->setAttrib("class", "form-control");
        ...
        $accountclasstypeid->setAttrib("class", "form-control");
        ...
        $bankaccountid->setAttrib("class", "form-control");
        ...
        $accountnumber->setAttrib("class", "form-control");
