...
class Default_Form_employee extends Zend_Form
{
	public function init()
	{
        ...
        $reportingmanager->setAttrib("class", "form-control select");
        ...
        $empstatus->setAttrib("class", "form-control select");
        ...
        $extension_number->setAttrib("class", "form-control");
		$extension_number->setAttrib('maxLength', 12);
        ...
        $office_number->setAttrib('maxLength', 12);
        $office_number->setAttrib("class", "form-control");
        ...
        $office_faxnumber->setAttrib("class", "form-control");
		...
		$office_faxnumber->addValidator("regex",true,array(
		 ...
		 $biometricid = new Zend_Form_Element_Text('biometricid');
        $biometricid->setAttrib("class", "form-control");
		$biometricid->setLabel("BiometricId");
                
                $avayacode = new Zend_Form_Element_Text('avayacode');
        $avayacode->setAttrib("class", "form-control");
                $avayacode->setLabel("Avaya Code"); 
        //$biometricid->addFilter(new Zend_Filter_StringTrim());
		
		$yearsofexp = new Zend_Form_Element_Text('years_exp');
        $yearsofexp->setAttrib("class", "form-control");
		...
		$submit->setLabel('Save');	
                ...
                $employeeId->setAttrib("class", "form-control");
                ...
                $employeeNumId->setAttrib('maxLength', 12);
        $employeeNumId->setAttrib("class", "form-control");
                ...
                $employeeNumId->addValidator("regex",true,array(                          
                           'pattern'=>'/^([0-9]|[a-z])+([0-9a-z]+)$/i',
                           'messages'=>array(
                               'regexNotMatch'=>'Please enter alpha numeric.'
                           )));               
...
/*                $final_emp_id->addValidator(new Zend_Validate_Db_NoRecordExists(
                ...
                $other_modeofentry->setLabel("Mode of Emp");
                $other_modeofentry->setAttrib("class", "form-control");
                $other_modeofentry->setAttrib('maxlength', 50);
                
                $modeofentry = new Zend_Form_Element_Select("modeofentry");                
                $modeofentry->setLabel("Mode of Emp")
                ...
                $disp_requi->setAttrib("class", "form-control");
		...
		$this->addElements(array($id,$userid,$reportingmanager,$empstatus,$businessunit,$department,$jobtitle,
                                         $position,$prefix_id,$extension_number,$office_number,$office_faxnumber,$biometricid,$avayacode, $yearsofexp,$date_of_joining,$date_of_leaving,$submit,$employeeId,
