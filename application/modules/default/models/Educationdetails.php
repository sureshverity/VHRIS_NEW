...
{	
    ...
    public function geteducationdetails($sort, $by, $pageNo, $perPage,$searchQuery,$userid)
	{
		...
		$empeducationDetails = $this->select()
						...
						->from(array('e'=>'main_empeducationdetails'),array('id'=>'id','institution_name'=>'institution_name','course'=>'course','remarks'=>'remarks','from_date'=>'DATE_FORMAT(from_date,"'.DATEFORMAT_MYSQL.'")','to_date'=>'DATE_FORMAT(to_date,"'.DATEFORMAT_MYSQL.'")','percentage'=>'percentage'))
