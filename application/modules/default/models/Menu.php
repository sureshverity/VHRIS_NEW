...
class Default_Model_Menu extends Zend_Db_Table_Abstract
{
	...
	public function getisactivemenus()
	{
		...
		$arr_menu_ids = array(TIMEMANAGEMENT, PERFORMANCEAPPRAISAL, RESOURCEREQUISITION, BGCHECKS, STAFFING, COMPLIANCES, REPORTS, BENEFITS, SERVICEDESK,EXPENSES, ASSETS , PAYROLL);
