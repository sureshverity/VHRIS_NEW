...
?>
            <div class="pagination">
                ...
                <input type="text" readonly id="pagenotext" data-max-page="40" />
...
protected function _getAcl()
{
  ...
  ?>";
	...
	{ 
		...
		$htmlContent .= '<a href="'.$append_url1.'" class ="cls_redirect link__f"><div class="dashboard_wid_box_inner">Candidates<span class="box_count">0</span></div></a>
			<a href="'.$append_url2.'" class ="cls_redirect link__l"><div class="dashboard_wid_box_inner last-child">Employees<span class="box_count">0</span></div></a>';
		if(!empty($url))
		$htmlContent .= '<a href="'.BASE_URL.$url.'"class="box_link view_link">'.$btnText.'</a>';
		}
		else{
			$htmlContent .= '<a href="'.$append_url1.'" class ="cls_redirect link__f"><div class="dashboard_wid_box_inner">Candidates<span class="box_count">'.(isset($format2[0])? $format2[0]:0).'</span></div>
			<a href="'.$append_url2.'" class ="cls_redirect link__l"><div class="dashboard_wid_box_inner last-child">Employees<span class="box_count">'.(isset($format2[1])? $format2[1]:0).'</span></div>';
			if(!empty($url))
			$htmlContent .= '<a href="'.BASE_URL.$url.'"class="box_link view_link">'.$btnText.'</a>';
			}
	      ...
	      if($id == 14 || $id == 34)
		   ...
		   else
		   {
		   	...
		   	if(!empty($format4))
			{
				...
				$htmlContent .='<a '.$href1.' class ="cls_redirect link__f"><div class="dashboard_wid_box_inner">'.$title1.'<span class="box_count">'.$format4['param2'] .'</span></div></a>
						<a '.$href2.' class ="cls_redirect link__l"><div class="dashboard_wid_box_inner last-child">'.$title2.'<span class="box_count">'. $format4['param3'].'</span></div></a>';
			}
			else
			{
				$htmlContent .='<a href="'.$append_url1.'" class ="cls_redirect link__f"><div class="dashboard_wid_box_inner">'.$title1.'<span class="box_count">0</span></div></a>
						<a href="'.$append_url2.'" class ="cls_redirect link__l"><div class="dashboard_wid_box_inner last-child">'.$title2.'<span class="box_count">0</span></div></a>';
			}	
				if(!empty($url)) 
				$htmlContent .='<a href="'.BASE_URL.$url.'"class="box_link view_link">'.$btnText.'</a>';
				$htmlContent .='</div>';
