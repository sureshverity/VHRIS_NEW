...
?>
         <div class="form-group<?php echo $extra_class;?>">
             <label class="col-md-3 control-label required<?php echo $required;?>"><?php echo $form->$element->getLabel();?> <?php echo $labelimg;?></label>
        ...
        {    		
            ...
            try
            {
                ...
                for($i=2; $i <= $sizeOfWorksheet; $i++ )
                {
                    ...
                    if (!empty($rowData[3]) && strlen($rowData[3]) > 12)
                    {
                ...
                if($tot_rec_cnt > 0)
                {
                    for($i=2; $i <= $sizeOfWorksheet; $i++ )
                    {
                        ...
                        $text = "<div style='padding: 0; text-align: left; font-size:14px; font-family:Arial, Helvetica, sans-serif;'>				
                                        ...
                                        <div style='padding:20px 0 0 0;color:#3b3b3b;'>You have been added to ". APPLICATION_NAME.". The login credentials for your VHRIS account are:</div>
                                        ...
                                        <div style='padding:20px 0 10px 0;'>Please <a href='".BASE_URL."index' target='_blank' style='color:#b3512f;'>click here</a> to login  to your VHRIS account.</div>
...
public static function createNew($loginUserId)
     ...
     $employeeModal = new Default_Model_Employee();
           ...
           <div id="dd" class="wrapper-dropdown-sf" tabindex="1"> <span></span><h6>Create New</h6>
						<ul class="dropdown">
			<?php 
...
<?php 
	...
	public static function displayLeaveTypeDiv($leavesCountArray){
		...
		foreach ($leavesCountArray as $key => $value) {
			//if($key!='all') {?>
				<div id="filter_<?php echo $key;?>" class="clickable_menu count_new_dis blocks__<?php echo $key;?>" parent-div="div_mchilds_<?php echo EMPLOYEESELFSERVICE;?>" super-parent="main_parent_<?php echo EMPLOYEESELFSERVICE;?>" 
