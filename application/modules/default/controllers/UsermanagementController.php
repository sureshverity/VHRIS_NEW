		...
		if($flag == 'activated')
		{
			...
			foreach($emailids as $email)
			{
				...
				$options['message'] = '<div>
										...
										<div></div>											
										<div style="padding:20px 0 10px 0;">Please <a href="'.$baseUrl.'/index/popup" target="_blank" style="color:#b3512f;">click here</a> to login  to your VHRIS account.</div>
										</div>';	
				$options['cron'] = 'yes';
				$result = sapp_Global::_sendEmail($options);
			}
			...
			$options['message'] = '<div>
									...
									<div></div>	
									<div style="padding:20px 0 10px 0;">Please <a href="'.$baseUrl.'/index" target="_blank" style="color:#b3512f;">click here</a> to login  to your VHRIS account.</div>																			
									</div>';	
			$options['cron'] = 'yes';
			$result = sapp_Global::_sendEmail($options);
		}
