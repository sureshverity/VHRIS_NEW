...
class Default_ShifttypesController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
       ...
       // echo 'shift'; exit;
        $shifttypesmodel = new Default_Model_Shifttypes();
        $call = $this->_getParam('call');
        if($call == 'ajaxcall')
            $this->_helper->layout->disableLayout();
//        if($loginuserRole == 5)
//        {
//            $this->_redirect('shifttypes/view/id/'.$loginUserId);
//        }
//        else{
            ...
            $dataTmp = $shifttypesmodel->getGrid($sort, $by, $perPage, $pageNo, $searchData,$call,$dashboardcall);
            ...
            $this->render('shifttypes/index', null, true);
       // }
    }
    ...
    public function addAction()
    {
        ...
        if($callval == 'ajaxcall')
            $this->_helper->layout->disableLayout();
        $addform = new Default_Form_shifttypes();
