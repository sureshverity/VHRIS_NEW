...
class Zend_View_Helper_Grid extends Zend_View_Helper_Abstract {
	...
	public function grid ($dataArray)
	{
		...
		{			
			...
			$editpopup_str = '<a id="edit{{id}}" onclick="displaydeptform(\''.BASE_URL.$dataArray['objectname'].'/'.$editaction.'/id/{{id}}'.$con.'/popup/1\',\''.$menunamestr.'\')" name="{{id}}" class="btn btn-default btn-condensed"  title=\'Edit\' ><span class="fa fa-pencil"></span></a>';
			$deletepopup_str = '<a name="{{id}}" id="del{{id}}" onclick= changestatus(\''.$dataArray['objectname'].'\',\'{{id}}\',\''.$msgdta.'\')	href= javascript:void(0) title=\'Delete\' class="btn btn-default btn-condensed" ><span class="fa fa-times"></span></a>';
				...
				if(!in_array('view',$actions_arr) && !in_array('edit',$actions_arr) && !in_array('delete',$actions_arr))
				{
				  ...
				  {	
					 ...
					 $extra['action'] = array('name' => 'edit', 'value' =>'<div class="grid-action-align btn-group">
								...
								<a name="{{id}}" id="{{id}}" onclick= changestatus(\''.$dataArray['objectname'].'\',\'{{id}}\',\''.$msgdta.'\')	href= javascript:void(0) title=\'Delete\' class="btn btn-default btn-condensed" ><span class="fa fa-times"></span></a>
							</div>'); 
				  }
				  else 
					$extra['action'] =array(); 				  
				}else
				{
					...
					if($dataArray['objectname'] ==  'empleavesummary' || $dataArray['objectname'] ==  'empscreening')
					{
                        ...
                        $delete_str = '<a name="{{id}}" onclick= changestatus(\''.$dataArray['objectname'].'\',\'{{id}}\',\''.$msgdta.'\')	href= javascript:void(0) title=\'Delete\' class="btn btn-default btn-condensed" ><span class="fa fa-times"></span></a>';
						$extra['action'] = array('name' => 'edit', 'value' =>'<div class="grid-action-align btn-group">
		...
		else
		{
			$formgridVal = '';
			            ...
			            if($dataArray['objectname'] == 'appraisalconfig' || $dataArray['objectname'] == 'appraisalcategory' || $dataArray['objectname'] == 'appraisalquestions' || $dataArray['objectname'] == 'appraisalmanager' || $dataArray['objectname'] == 'feedforwardquestions' || $dataArray['objectname'] == 'announcements') 
			            	$edit_str = '<a href= "'.BASE_URL.$dataArray['objectname'].'/edit/id/{{id}}" name="{{id}}" id="edit{{id}}" class="btn btn-default btn-condensed"  title=\'Edit\'><span class="fa fa-pencil"></span></a>';
			            elseif($dataArray['objectname'] == 'manageremployeevacations'){
			            	$edit_str = '<a name="{{id}}" onclick= displaydeptform(\''.BASE_URL.'leaverequest/editpopup/id/{{id}}'.'\',\'\')	href= javascript:void(0) title=\'Approve or Reject or Cancel Leave\' class="btn btn-default btn-condensed" ></a>';
			            }
			            else {
                        	$edit_str = '<a href= "'.BASE_URL.$dataArray['objectname'].'/edit/id/{{id}}" name="{{id}}" class="btn btn-default btn-condensed"  title=\'Edit\'><span class="fa fa-pencil"></span></a>';
			            }
						...
						if($dataArray['objectname'] == 'pendingleaves')
						   $delete_str = '<a id="cancel_leave_{{id}}" name="{{id}}" onclick= changestatus(\''.$dataArray['objectname'].'\',\'{{id}}\',\''.$msgdta.'\')	href= javascript:void(0) title=\'Cancel Leave\' class="btn btn-default btn-condensed" ></a>';
						else if($dataArray['objectname'] == 'usermanagement')
							 $delete_str = '<a id="del{{id}}" name="{{id}}" onclick= changestatus(\''.$dataArray['objectname'].'\',\'{{id}}\',\''.$msgdta.'\')	href= javascript:void(0) title=\'Delete\' class="btn btn-default btn-condensed" ><span class="fa fa-times"></span></a>';
	...
	public function generateGrid ($name, $fields = null,$paginator=null,$extracolumn=array(),$sorting=false,$jsGridFnname='', $perPage='5',$page='1', $jsFillFnName='',$searchArray='',$formgrid='false',$addaction='',$menuName='',$unitId,$addpermission,$menunamestr,$call='',$sortStr='',$search_filters = '',$dashboardCall = 'No',$empstatus = '',$actnArr,$empscreenTotalCount = '',$sortname='',$by='') {
		...
		if($formgrid != '')
		{
			...
			{		
				$empaction = 'add';
				$output ="<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'>".$menuName."</h3><a href='".BASE_URL.$name.'/'.$empaction."'><input type='button' title = 'Adds'  value='Add Record' class='sprite addrecord' /></a>";
			}
			else
			{
				if($name == 'processes' && $empstatus != 'Active' && $empstatus != '')
					$output ="<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'>".$menuName."</h3>";
				else
					$output ="<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'>".$menuName."</h3><input type='button' title = 'Add'  onclick='displaydeptform(\"".BASE_URL.$name.'/'.$popupaction."/$con/popup/1\",\"".$menunamestr."\")' value='Add Record' class='sprite addrecord' />";
			}
		}
		else
		{
			if($name == 'policydocuments' && !empty($this->pd_category_name))
				$output ="<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'><span>".$this->pd_category_name."</span></h3>";
			else
				$output ="<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'><span>".$menuName."</span></h3>";
			...
			{
				$output .= "<ul class='panel-controls col-md-pull-1'><li><a href='".BASE_URL.$name.'/'.$action."/cat/".$this->pd_category_id."'><span class='fa fa-plus'></span></a></li></ul></div>";
			}
			else{
		  		$output .= "<ul class='panel-controls col-md-pull-1'><li><a href='".BASE_URL.$name.'/'.$action."'><span class='fa fa-plus'></span></a></li>";
			}
			$output .= "</div>";
		} 
		...
		{	
			if($name == 'policydocuments' && !empty($this->pd_category_name))
				$output ="<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'><span>".$this->pd_category_name."</span></h3></div>";
			else
				$output ="<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'><span>".$menuName."</span></h3></div>";
		}
