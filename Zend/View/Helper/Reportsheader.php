...
class Zend_View_Helper_Reportsheader extends Zend_View_Helper_Abstract {
	...
	public  function reportsheader($module)
	{
		    ...
		    $reportsheader .='</li>';
                    ...
                    $reportsheader .='<li class="reports-div" id="payroll_rpt_div" >';
                    if($module == 'payroll'){
			 $reportsheader .='<span class="reports-sprite payroll-report-selected"></span>';
			$reportsheader .='<p class="one-line selected-report">Payroll</p>';
			}else
                        {
			$reportsheader .='<span class="reports-sprite payroll-report"></span>';
			$reportsheader .='<p class="one-line">Payroll</p>';
			}
                        $reportsheader .='</li>';
                        $reportsheader .='<li class="reports-div" id="attendance_rpt_div" >';
                        if($module == 'attendance'){
			 $reportsheader .='<span class="reports-sprite attendance-report-selected"></span>';
			$reportsheader .='<p class="one-line selected-report">Attendance</p>';
			}else
                        {
			$reportsheader .='<span class="reports-sprite attendance-report"></span>';
			$reportsheader .='<p class="one-line">Attendance</p>';
			}
                    $reportsheader .='</li>';
