...
class Zend_View_Helper_Employeegrid extends Zend_View_Helper_Abstract {
	...
	public function generateGrid ($name, $fields = null,$paginator=null,$extracolumn=array(),$sorting=false,$jsGridFnname='', $perPage='5',$page='1', $jsFillFnName='',$searchArray='',$formgrid='false',$addaction='',$menuName='',$unitId,$addpermission,$menunamestr,$call='',$sortStr='',$conText="",$search_filters = '',$dashboardCall='No',$actnArr,$sortname='',$by='') {        
		...
		{	
			...
			{	
				$actionStr = 'add';
				$output ="<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'>".$menuName."</h3><ul class='panel-controls col-md-pull-1'><li><a href='#' title = 'Add' onclick='window.location.href=\"".BASE_URL.$name.'/'.$actionStr."\"' /><span class='fa fa-plus'></span></a></li></ul></div>";
			}
			else
			{	
				$output ="<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'>".$menuName."</h3><ul class='panel-controls col-md-pull-1'><li><a href='#' title = 'Add' onclick='window.location.href=\"".BASE_URL.$name.'/'.$action."\"' /><span class='fa fa-plus'></span></a></li></ul></div>";
			}
		} 
