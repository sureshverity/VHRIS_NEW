...
class Zend_View_Helper_Requisitiongrid extends Zend_View_Helper_Abstract {
	...
	public function generateGrid ($name, $fields = null,$paginator=null,$extracolumn=array(),$sorting=false,$jsGridFnname='', $perPage='5',$page='1', $jsFillFnName='',$searchArray='',$formgrid='false',$addaction='',$menuName='',$unitId,$addpermission,$actns='',$menunamestr,$call='',$sortStr='',$search_filters = '',$dashboardCall = 'No',$actnArr,$sortname='',$by='') {
		...
		if($formgrid != '')
		{
			...
			$con = 'unitId/'.$params['id'];
			$output ="<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'>".$menuName."</h3> <ul class='panel-controls col-md-pull-1'><li><a href='#' title = 'Add' onclick='displaydeptform(\"".BASE_URL.$name.'/'.$popupaction."/$con/popup/1\",\"".$menunamestr."\")'  /><span class='fa fa-plus'></span></a></li></ul></div>";
		}
		else
		{
			$menuName = $menu_model->getMenuText($menuName);
            
    		$output ="<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'>".$menuName."</h3><ul class='panel-controls col-md-pull-1'><li><a href='#' title = 'Add'  onclick='window.location.href=\"".BASE_URL.$name.'/'.$action."\"'/><span class='fa fa-plus'></span></a></li>";
                $output .="</ul></div>";
		} 
		...
		{	
			...
			$output ="<div class='panel panel-default'><div class='table-header'><span>".$menuName."</span></div>";
		}
...
<script type='text/javascript' language='javascript'>
		...
		$output .= "<script type='text/javascript'>"
                        . "debugger;$('#$name').slimScrollHorizontal({
									  alwaysVisible: false,
									  start: 'left',
									  position: 'bottom',
									  width: '1020px',
